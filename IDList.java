...
public class IDList {
			...
			// sets, and returns a boolean.
			
			/** 
			 * @param id The tweet ID.
			 * @return A boolean whether the ID is in the list of IDs which are manually assigned to have
			 * "ContinuingNews" category.
			 */
			...
			/** 
			 * @param id The tweet ID.
			 * @return A boolean whether the ID is in the complete list of IDs.
			 */

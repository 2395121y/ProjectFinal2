...
public class ArffList {
	 ...
	 * @param index The index to retrieve for the double ArrayList.
	 * @return ArrayList to be returned from the double ArrayList.
	 */
	 ...
	 * @return Number of tweets being processed.
	 */
	 ...
	 * @param idList The class containing the lists of IDs.
	 * @param lexicon The class containing the lexicon list.
	 * @param tweetCountList The class containing amount of tweets that contain some particular tokens.
	 */
			...
			try {
				...
				while ((line = br.readLine())!=null) {
					...
					if (idList.hasCompleteID(testID))
					{
						...
						if ((boolean) userProfile.get("verified"))
							arr.add("verified");
						else
							arr.add("notverified");
	 ...
	 * @param lexicon The class containing the lexicon list.
	 * @param tweetCountList The class containing the amount of tweets containing a particular token.
	 */
